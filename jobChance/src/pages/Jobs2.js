    ...
    <footer class = "footer">
      ...
      <table>
        <tbody>
          <tr>
          <td>
              <Link to="/Jobs"class="btn btn-dark">previous</Link>
            </td>
            <td>
            ...
            <td>
              <Link to="/Jobs3"class="btn btn-dark">Next</Link>
            </td>
          </tr>
        </tbody>
      </table>
