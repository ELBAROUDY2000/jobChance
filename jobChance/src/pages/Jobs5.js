    ...
    <footer class = "footer">
      ...
      <table>
        <tbody>
          <tr>
          <td>
              <Link to="/Jobs4"class="btn btn-dark">previous</Link>
            </td>
            <td>
            ...
            <td>
              <Link to="/jobs6"class="btn btn-dark">Next</Link>
            </td>
          </tr>
        </tbody>
      </table>
