    ...
    <footer class = "footer">
      ...
      <table>
        <tbody>
          <tr>
          <td>
              <Link to="/Jobs2"class="btn btn-dark">previous</Link>
            </td>
            <td>
            ...
            <td>
              <Link to="/jobs4"class="btn btn-dark">Next</Link>
            </td>
          </tr>
        </tbody>
      </table>
