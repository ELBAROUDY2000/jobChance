    ...
    <footer class = "footer">
      ...
      <table>
        <tbody>
          <tr>
          <td>
              <Link to="/Jobs6"class="btn btn-dark">previous</Link>
            </td>
            <td>
            ...
            <td>
              <Link to="/jobs8"class="btn btn-dark">Next</Link>
            </td>
          </tr>
        </tbody>
      </table>
