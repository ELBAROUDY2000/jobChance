    ...
    <footer class = "footer">
      ...
      <table>
        <tbody>
          <tr>
          <td>
              <Link to="/Jobs7"class="btn btn-dark">previous</Link>
            </td>
            <td>
            ...
            <td>
              <Link to="/Jobs9"class="btn btn-dark">Next</Link>
            </td>
          </tr>
        </tbody>
      </table>
