  ...
  <div class="container-fluid p-4">
      ...
      <div class="col">
        <div class="card">
          ...
          />
          <div class="card-body">
            <h5 class="card-title">Job 100</h5>
            <p class="card-text">
              This is a longer card with supporting text below as a natural
              lead-in to additional content. This content is a little bit
              longer.
      ...
      <div class="col">
        <div class="card">
          ...
          />
          <div class="card-body">
            <h5 class="card-title">Job 102</h5>
            <p class="card-text">
              This is a longer card with supporting text below as a natural
              lead-in to additional content. This content is a little bit
              longer.
      ...
      <div class="col">
        <div class="card">
          ...
          />
          <div class="card-body">
            <h5 class="card-title">Job 103</h5>
            <p class="card-text">
              This is a longer card with supporting text below as a natural
              lead-in to additional content. This content is a little bit
              longer.
      ...
      <div class="col">
        <div class="card">
          ...
          />
          <div class="card-body">
            <h5 class="card-title">Job 104</h5>
            <p class="card-text">
              This is a longer card with supporting text below as a natural
              lead-in to additional content. This content is a little bit
              longer.
      ...
      <div class="col">
        <div class="card">
          ...
          />
          <div class="card-body">
            <h5 class="card-title">Job 105</h5>
            <p class="card-text">
              This is a longer card with supporting text below as a natural
              lead-in to additional content. This content is a little bit
              longer.
      ...
      <div class="col">
        <div class="card">
          ...
          />
          <div class="card-body">
            <h5 class="card-title">Job 106</h5>
            <p class="card-text">
              This is a longer card with supporting text below as a natural
              lead-in to additional content. This content is a little bit
              longer.
      ...
      <div class="col">
        <div class="card">
          ...
          />
          <div class="card-body">
            <h5 class="card-title">Job 107</h5>
            <p class="card-text">
              This is a longer card with supporting text below as a natural
              lead-in to additional content. This content is a little bit
              longer.
      ...
      <div class="col">
        <div class="card">
          ...
          />
          <div class="card-body">
            <h5 class="card-title">Job 108</h5>
            <p class="card-text">
              This is a longer card with supporting text below as a natural
              lead-in to additional content. This content is a little bit
              longer.
      ...
      <div class="col">
        <div class="card">
          ...
          />
          <div class="card-body">
            <h5 class="card-title">Job 109</h5>
            <p class="card-text">
              This is a longer card with supporting text below as a natural
              lead-in to additional content. This content is a little bit
              longer.
    ...
    <footer class = "footer">
      ...
      <table>
        <tbody>
          <tr>
          <td>
              <Link to="/Jobs8"class="btn btn-dark">previous</Link>
            </td>
            <td>
